...
impl MatchTracker {
    ...
    pub fn init_diff<'o>(&mut self, parent: Option<Tag>) -> InitDiff<'_> {
    ...
    pub fn match_use_by_ident<'o>(
        ...
        let tag = origin.local.lookup.use_by_ident(origin.domain, ident)?;
    ...
    pub fn match_def_by_ident<'o>(
        ...
        let tag = origin.local.lookup.def_by_ident(origin.domain, ident)?;
    ...
    pub fn match_arc_by_ident<'o>(
        ...
        let tag = origin.local.lookup.arc_by_ident(origin.domain, ident)?;
...
impl ProjectedSemModel {
    pub fn new_tracker(&self) -> MatchTracker {
    ...
    pub fn merge_tracker(&mut self, tracker: MatchTracker) {
