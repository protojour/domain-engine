                ...
                YielderMock::yield_match
                    .next_call(matching!(
                        ...
                        eq!(&Literal(indoc! { r#"
                            (root $a)
                            (is-entity $a def@1:2)
                            (match-prop $a rel@1:2:0 (element-in $b))
                            (member $b (_ 'input'))
                        "#
                        }))
                    ))
                ...
                YielderMock::yield_match
                    .next_call(matching!(
                        ...
                        eq!(&Literal(indoc! { r#"
                            (root $a)
                            (is-entity $a def@1:2)
                            (match-prop $a rel@1:2:2 (element-in $b))
                            (match-prop $a rel@1:2:3 (element-in $c))
                            (member $b (_ 'A'))
                            (member $c (_ 'B'))
                        "#
                        }))
                ...
                YielderMock::yield_match
                    .next_call(matching!(
                        ...
                        eq!(&Literal(indoc! { r#"
                                (root $a)
                                (is-entity $a def@1:1)
                                (match-prop $a rel@1:1:2 (superset-of $b))
                                (member $b (_ 'x!'))
                                (member $b (_ 'y!'))
                            "#
                        }))
                ...
                YielderMock::yield_match
                    .next_call(matching!(
                        ...
                        eq!(&Literal(indoc! { r#"
                            (root $a)
                            (is-entity $a def@1:1)
                            (match-prop $a rel@1:1:3 (element-in $c))
                            (match-prop $b rel@1:2:0 (superset-of $d))
                            (member $c (_ $b))
                            (member $d (_ 'x!'))
                        "#
                        }))
                ...
                YielderMock::yield_match
                    .next_call(matching!(
                        ...
                        eq!(&Literal(indoc! { r#"
                            (root $a)
                            (is-entity $a def@1:1)
                            (match-prop $a rel@1:1:2 (element-in $c))
                            (is-entity $b def@1:2)
                            (match-prop $b rel@1:2:2 (superset-of $d))
                            (member $c (_ $b))
                            (member $d (_ 'x'))
                            (member $d (_ 'y'))
                        "#
